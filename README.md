...
Meet the core team of daily.dev:
 ...
 <img class="img" width = "10%" hspace=5 vspace=5 src="assets/nimrod.jpg" /><!-------
-->
  <img class="img" width = "10%" hspace=5 vspace=5 src="assets/ido.jpg" /><!-------
-->
 <img class="img" width = "10%" hspace=5 vspace=5 src="assets/tsa.jpg" />
</div>
